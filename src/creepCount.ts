export const creepRolesForLevel: {
    ...
    1: {
        ...
        work5: { role: "work", body: [{ type: "work", count: 1 }, { type: "carry", count: 2 }, { type: "move", count: 2 }] },
        work6: { role: "work", body: [{ type: "work", count: 1 }, { type: "carry", count: 2 }, { type: "move", count: 2 }] },
    },
    2: {
        ...
        work5: { role: "work", body: [{ type: "work", count: 2 }, { type: "carry", count: 3 }, { type: "move", count: 3 }] },
        work6: { role: "work", body: [{ type: "work", count: 2 }, { type: "carry", count: 3 }, { type: "move", count: 3 }] },
    },
    3: {
        ...
        work5: { role: "work", body: [{ type: "work", count: 3 }, { type: "carry", count: 4 }, { type: "move", count: 4 }] },
        work6: { role: "work", body: [{ type: "work", count: 3 }, { type: "carry", count: 4 }, { type: "move", count: 4 }] },
    },
    4: {
