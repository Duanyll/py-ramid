export const creepRolesForLevel: {
    ...
    4: {
        harv1: { role: "harvest", body: [{ type: "work", count: 6 }, { type: "carry", count: 8 }, { type: "move", count: 7 }] },
        harv2: { role: "harvest", body: [{ type: "work", count: 6 }, { type: "carry", count: 8 }, { type: "move", count: 7 }] },
        build1: { role: "build", body: [{ type: "work", count: 6 }, { type: "carry", count: 8 }, { type: "move", count: 7 }] },
        build2: { role: "build", body: [{ type: "work", count: 6 }, { type: "carry", count: 8 }, { type: "move", count: 7 }] },
